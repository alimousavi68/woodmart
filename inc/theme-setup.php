...
if( ! function_exists( 'woodmart_register_required_plugins' ) ) {
 ...
 array(
	            'name'               => 'ایمپورت دموی های اختصاصی توسعه وردپرس', // The plugin name.
	            'slug'               => 'devwp-importer', // The plugin slug (typically the folder name).
	            'source'             => get_parent_theme_file_path( WOODMART_FRAMEWORK . '/plugins/devwp-importer.zip' ), // The plugin source.
	            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
	            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
	        ),

...
elseif($woodmart_demos=="dgkala")
{
wp_enqueue_style( 'dgkala', WOODMART_THEME_DIR . '/css/dgkala.css', array(), $version );

}
elseif($woodmart_demos=="corporate")
{
wp_enqueue_style( 'corporate', WOODMART_THEME_DIR . '/css/corporate.css', array(), $version );
...
elseif($woodmart_demos=="base2")
{wp_enqueue_style( 'base2', WOODMART_THEME_DIR . '/css/base2.css', array(), $version );

}
elseif($woodmart_demos=="base3")
{wp_enqueue_style( 'base3', WOODMART_THEME_DIR . '/css/base3.css', array(), $version );

}
elseif($woodmart_demos=="espinas")
{wp_enqueue_style( 'espinas', WOODMART_THEME_DIR . '/css/espinas.css', array(), $version );

}

elseif($woodmart_demos=="base4")
{wp_enqueue_style( 'base4', WOODMART_THEME_DIR . '/css/base4.css', array(), $version );

	...
	public function add_options() {
		Options::add_section(
			array(
				...
				'name'     => esc_html__( 'تعداد فروخته شده', 'woodmart' ),
				'priority' => 90,
				'icon'     => 'xts-i-cart',
			)
		);
		...
		Options::add_field(
			array(
				...
				'description' => esc_html__( 'نمایش تعداد فروش برای آخرین دوره.', 'woodmart' ),
				'type'        => 'switcher',
		...
		Options::add_field(
			array(
				...
				'name'        => esc_html__( 'نمایش نوع فروش', 'woodmart' ),
				'description' => esc_html__( 'شما می توانید تعداد واقعی تعداد سفارشات را برای این محصول نشان دهید یا یک عدد جعلی تصادفی تنظیم کنید.', 'woodmart' ),
				'type'        => 'buttons',
				'section'     => 'sold_counter',
				'options'     => array(
					'real_data' => array(
		...
		Options::add_field(
			array(
				...
				'name'       => esc_html__( 'حداقل تعداد فروش', 'woodmart' ),
				'type'       => 'text_input',
				'attributes' => array(
					'type' => 'number',
					'min'  => '0',
		...
		Options::add_field(
			array(
				...
				'name'     => esc_html__( 'برای محصولاتی که در انبار موجود نیستند پنهان شوید', 'woodmart' ),
				'type'     => 'switcher',
				'section'  => 'sold_counter',
				'default'  => false,
				'on-text'  => esc_html__( 'Yes', 'woodmart' ),
		...
		Options::add_field(
			array(
				...
				'name'        => esc_html__( 'دوره زمانی', 'woodmart' ),
				'description' => esc_html__( 'مقدار بازه زمانی سفارشی را مشخص کنید.', 'woodmart' ),
				'type'        => 'range',
				'section'     => 'sold_counter',
				'default'     => 3,
				'min'         => 1,
		...
		Options::add_field(
			array(
				...
				'name'        => esc_html__( 'بازه زمانی', 'woodmart' ),
				'description' => esc_html__( 'دوره زمانی سفارشی را انتخاب کنید', 'woodmart' ),
				'type'        => 'select',
				'section'     => 'sold_counter',
				'options'     => array(
					'minutes' => array(
						'name'  => esc_html__( 'دقیقه', 'woodmart' ),
						'value' => 'minutes',
					),
					'hours'   => array(
						'name'  => esc_html__( 'ساعت', 'woodmart' ),
						'value' => 'hours',
					),
					'days'    => array(
						'name'  => esc_html__( 'روز', 'woodmart' ),
						'value' => 'days',
					),
					'weeks'   => array(
						'name'  => esc_html__( 'هفته', 'woodmart' ),
						'value' => 'weeks',
					),
					'months'  => array(
		...
		Options::add_field(
			array(
				...
				'name'        => esc_html__( 'طول عمر کش', 'woodmart' ),
				'description' => esc_html__( 'زمانی را بر حسب ساعت مشخص کنید که پس از آن کش فروش محصول پاک می شود.', 'woodmart' ),
				'type'        => 'range',
				'section'     => 'sold_counter',
				'default'     => 24,
				'min'         => 1,

...
Options::add_field(
	array(
		'id'          => 'load_text_domain',
		'name'        => esc_html__( 'بارگذاری فایل ترجمه', 'woodmart' ),
		'description' => esc_html__( 'آن را فعال کنید تا ترجمه ها را از همه مکان های ممکن بارگیری کند. معمولاً باید غیرفعال شود، بنابراین ترجمه از پوشه سیستم فقط wp-content/languages/themes بارگیری می شود و عملکرد بهتر خواهد بود..', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'performance_other',
		'default'     => true,
		'priority'    => 20,

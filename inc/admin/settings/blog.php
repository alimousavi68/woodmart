...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'نمایش عنوان پست', 'woodmart' ),
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'نمایش دسته بندی ها ، آیکون اشتراک گذاری  ، نویسنده', 'woodmart' ),
		'group'       => esc_html__( 'Elements', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'blog_archive_section',
		'default'     => '1',
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'نمایش چکیده مطلب', 'woodmart' ),
		'group'       => esc_html__( 'Elements', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'blog_archive_section',
		'default'     => '1',
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'نمایش دکمه ادامه مطلب ', 'woodmart' ),
		'group'       => esc_html__( 'Elements', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'blog_archive_section',
		'default'     => '1',

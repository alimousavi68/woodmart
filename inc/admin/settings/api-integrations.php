...
Options::add_field(
	array(
		...
		'name'        => esc_html__( 'حذف تصاویر قدیمی', 'woodmart' ),
		'description' => esc_html__( 'این گزینه تصاویر منسوخ شده را به طور خودکار از کتابخانه رسانه حذف می کند و فقط جدیدترین ها را از حساب شما حفظ می کند. با تصاویر اضافه شده به کتابخانه رسانه از نسخه WoodMart 7.2 کار می کند.', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'instagram_api_section',
		'priority'    => 20,
	)
